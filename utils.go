...
// I didn't check src type because it should be generated by the createModelPointerAndSlice
// so if this function return nil, go to check createModelPointerAndSlice first, make sure createModelPointerAndSlice can pass its unit test
